...
- Simulations were run for configurations with 1, 3, # Script-Based HSPICE Simulation for Driver Optimization
...
**Minimum Delay Achieved**: **160.41 ps** **Optimized Stage Sizes (multipliers)**: `[2.68, 6.39, 15.85]`  
...
**Difference**: 8.99%5, 7, and 9 stages. The analysis concluded that a **3-stage design** provides the optimal delay
